  ...
  return (
    <>
      <FormControl sx={{ flexShrink: 0, width: { xs: 1, md: 200 } }}>
        <InputLabel htmlFor="filter-stock-select">재고</InputLabel>
      ...
      <FormControl sx={{ flexShrink: 0, width: { xs: 1, md: 200 } }}>
        <InputLabel htmlFor="filter-publish-select">게시</InputLabel>
        <Select
          multiple
          value={publish}
          onChange={handleChangePublish}
          onClose={handleFilterPublish}
          input={<OutlinedInput label="게시" />}
          renderValue={(selected) => selected.map((value) => value).join(', ')}
